...
import { getUsers, createFavCharacter, getFavCharacter, createFavPlanet, getFavPlanet, getFav, removeFavCharacter, removeFavPlanet } from './actions';
...
router.delete('/user/character/:user_id/:character_id', verifyToken, safe(removeFavCharacter));
router.delete('/user/planet/:user_id/:planet_id', verifyToken, safe(removeFavPlanet));
